...
src/error_handler_unit_test.py:18: in test_handle_standard_exception
    assert "Traceback" in mock_logging.call_args_list[1][0][0]
E   AssertionError: assert 'Traceback' in 'NoneType: None/n'
...
src/error_handler_unit_test.py:30: in test_handle_custom_exception
    assert "Traceback" in mock_logging.call_args_list[1][0][0]
E   AssertionError: assert 'Traceback' in 'NoneType: None/n'
-------------------------------------------------------------------------- Captured stdout call --------------------------------------------------------------------------
An error occurred. Check the log for details.
...
src/error_handler_unit_test.py:40: in test_handle_system_exception
    assert "Traceback" in mock_logging.call_args_list[1][0][0]
E   AssertionError: assert 'Traceback' in 'NoneType: None/n'
-------------------------------------------------------------------------- Captured stdout call --------------------------------------------------------------------------
An error occurred. Check the log for details.
======================================================================== short test summary info =========================================================================
FAILED src/error_handler_unit_test.py::test_handle_standard_exception - AssertionError: assert 'Traceback' in 'NoneType: None/n'
FAILED src/error_handler_unit_test.py::test_handle_custom_exception - AssertionError: assert 'Traceback' in 'NoneType: None/n'
FAILED src/error_handler_unit_test.py::test_handle_system_exception - AssertionError: assert 'Traceback' in 'NoneType: None/n'
====================================================================== 3 failed, 33 passed in 2.09s ======================================================================
